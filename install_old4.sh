...
# Interactive select  BitRate CAN0 (using whiptail)
if whiptail --title "BitRate CAN0" --yes-button " VAG " --no-button " MERCEDES " --yesno "    VAG. BitRate can0 100000 for (RNSE, RNSD, MFD)\n\n    MERCEDES. BitRate can0 83333 for (COMMAND 2.0)" 10 60; then
	green "     Use BitRate VAG"
	can0_bitrate_vag
	can0_service_run
else
	#rpi_composite
	green "     Use BitRate MERCEDES"
	can0_bitrate_mercedes
	can0_service_run
fi
